...
def handle_for_loop_with_variable(grouped_lines):
    expanded_lines = []
        ...
        if isinstance(item, tuple):
            ...
            if command.startswith("for"):
                ...
                for i in range(repeat_count):
                    expanded_block = [regex.sub(str(i), line) for line in block]
...
def main():
    ...
    expanded_lines = handle_for_loop_with_variable(grouped_lines)
